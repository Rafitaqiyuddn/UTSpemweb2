                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="jenis_produk_controller.php" method="post">
                                        <a href="index.php?hal=jenis_produk_detail&iddetail=<?= $row['id']?>">
                                            <button type="button" class="btn btn-info btn-sm"
                                                tittle="detail jenis produk">
                                                <i class="fa-solid fa-eye fa-beat"></i>
                                            </button>
                                        </a>
                                        <a href="index.php?hal=jenis_produk_edit&idedit=<?= $row['id']?>">
                                            <button type="button" class="btn btn-warning btn-sm"
                                                tittle="Edit jenis Produk">
                                                <i class="fa-solid fa-pen-to-square fa-beat"></i>
                                            </button>
                                        </a>
                                        <button type="button" class="btn btn-danger btn-sm" name="proses" value="hapus"
                                            onclick="return confirm('Apakah Anda Yakin ingin menghapus data produk yg bernama <?= $row['nama_jenis'] ?>')"
